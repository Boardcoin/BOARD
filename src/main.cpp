...
const string strMessageMagic = "Boardcoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if (pindexBest->nHeight+1 == 11)
      {
        int64_t nSubsidy = 1200000 * COIN;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Boardcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "B O A R D C O I N";
        CTransaction txNew;
        txNew.nTime = 1407386851;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1407386851;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 612803;
		if(fTestNet)
        {
            block.nNonce   = 1408513101;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x0f4ec2a319d75b58a047d5d67db612302af7da98f3347d18d6912a50e465e8e4"));
        block.print();
